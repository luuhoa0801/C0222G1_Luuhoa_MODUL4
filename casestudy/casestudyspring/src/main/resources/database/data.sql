...
('tháng'),
('năm');
insert into facility (area,cost,description_other_convenience,facility_free,max_people,`name`,number_of_floors,pool_area,standard_room,`status`,facility_type,rent_type) value
